...
try:
    ...
    # Local dev: wheel installed from a prior vllm release may predate the
    # stable-libtorch extension. Skipping is safe as long as no caller relies
    # on ops registered exclusively by this module.
    pass
